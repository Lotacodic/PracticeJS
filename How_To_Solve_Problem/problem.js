...
// 1) Understnading the problem
// - What is temp amplitude? Answer: difference between highest and lowest temp
// - How to compute max and min temperature
// - What's a sensor error? And what do they do?
...
const calcTempAmplitudeNew = function (t1, t2) {
    const temps = t1.concat(t2); // merges the two arrays(t1, t2)
    console.log(temps);
...
const amplitudeNew = calcTempAmplitudeNew([4, 6, 15], [13, 11, 25]);
